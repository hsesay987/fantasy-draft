...
async function main() {
    await (0, loadAdvanced_1.loadAdvanced)("src/data/Advanced.csv");
    await (0, loadPer36_1.loadPer36)("src/data/Per_36_Minutes.csv");
    await (0, loadPlayByPlay_1.loadPlayByPlay)("src/data/Play_By_Play.csv");
    await (0, loadAllStar_1.loadAllStar)("src/data/All_Star_Selections.csv");
    await (0, loadEndOfSeasonTeams_1.loadEndOfSeasonTeams)("src/data/End_of_Season_Teams.csv");
    await (0, loadAwardsVoting_1.loadAwardsVoting)("src/data/Player_Award_Shares.csv");
...
//   });
//# sourceMappingURL=seedNbaModern.js.map